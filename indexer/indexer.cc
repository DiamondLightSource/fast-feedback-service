...
int main(int argc, char **argv) {
    ...
    // implement px_to_mm parallax corrections
    // implement max cell/d_min estimation.
    ...
    std::array<double, 3> fast_axis {1.0, 0.0, 0.0}; //FIXME get through reader
