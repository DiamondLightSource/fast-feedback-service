...
TEST(BaselineIndexer, combinations_test){
    ...
    std::vector<Vector3d> basis_vectors {{10.0,0.0,0.0}, {10.0,1.0,0.0}, {0.0,2.5,0.0}, {0.0,0.0,50.0}};
    // Set the max combinations to be greater than the actual number of potential combinations.
    CandidateOrientationMatrices candidates = CandidateOrientationMatrices(basis_vectors, 10);
    int count = 0;
