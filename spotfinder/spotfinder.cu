...
// void do_worker_thread(std::stop_token stop_token,
//                       int thread_number,
//                       const PitchedMalloc<uint8_t> &mask,
//                       std::atomic<int> &next_image_num,
//                       H5Read &reader,
//                       std::mutex &reader_mutex) {
//     const int height = reader.image_shape()[0];
//     const int width = reader.image_shape()[1];
...
//     //     // auto image_num = next_image_num.
//     // }
//     // auto host_image = make_cura_pi
