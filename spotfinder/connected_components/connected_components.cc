...
ConnectedComponents::ConnectedComponents(const uint8_t *result_image,
    ...
    // Build graph
    auto graph = build_graph(width, height);
    ...
    generate_boxes(labels, num_labels, width, height, min_spot_size);
}
...
ConnectedComponents::build_graph(const ushort width, const ushort height) {
 ...
 */
void ConnectedComponents::generate_boxes(std::vector<int> labels,
                                         int num_labels,
                                         const ushort width,
                                         const ushort height,
                                         const uint32_t min_spot_size) {
